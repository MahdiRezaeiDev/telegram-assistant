...
<aside id="side_bar">
    <ul>
        <li style="display: flex; justify-content: end;">
            <img src="../../public/icons/close.svg" class="cursor-pointer ml-3 my-4" alt="close menu icon" onclick="toggleSidebar()">
        </li>
        <li class="mx-1 <?= $category == 'dashboard' ? 'bg-gray-300' : 'bg-gray-50' ?> hover:bg-gray-400 text-sm font-bold">
            <a class="p-3 mb-1 menu_item flex items-center gap-2" href="../dashboard/dashboard.php">
                <!-- <img class="hidden sm:inline-block" src="./assets/icons/add.svg" alt="add icon"> -->
                داشبورد
            </a>
        </li>
        <?php if (USER['role'] == 'admin'): ?>
            <li class="mx-1 <?= $category == 'users' ? 'bg-gray-300' : 'bg-gray-50' ?> hover:bg-gray-400 text-sm font-bold">
                <a class="p-3 mb-1 menu_item flex items-center gap-2" href="../profile/list.php">
                    <!-- <img class="hidden sm:inline-block" src="./assets/icons/add.svg" alt="add icon"> -->
                    مدیریت کاربران
                </a>
            </li>
        <?php endif; ?>
        <li class="mx-1 <?= $category == 'profile' ? 'bg-gray-300' : 'bg-gray-50' ?> hover:bg-gray-400 text-sm font-bold">
            <a class="p-3 mb-1 menu_item flex items-center gap-2" href="../profile/index.php">
                <!-- <img class="hidden sm:inline-block" src="./assets/icons/add.svg" alt="add icon"> -->
                پروفایل کاربری
            </a>
        </li>
    ...
    <ul>
        <li>
            <a class="flex justify-start items-center gap-2 p-4 hover:bg-gray-200 text-sm font-semibold" href="../auth/logout.php">
                <img src="../../public/icons/power.svg" alt="save icon">
                خروج از حساب کاربری
            </a>
        </li>
    </ul>
