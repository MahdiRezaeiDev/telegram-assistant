...
<nav id="main_nav" class="fixed top-0 left-0 right-0 z-50 p-2 flex justify-between bg-white shadow-md">
    <ul class="flex">
        ...
        <div class="hidden md:flex">
            ...
            <li class="mx-1 <?= $category == 'bazar' ? 'bg-gray-400' : 'bg-gray-200' ?> hover:bg-gray-400 text-sm font-bold">
                <a class="p-2 menu_item flex items-center gap-2" href="../bazar/index.php">
                    <!-- <img class="hidden sm:inline-block" src="./assets/icons/add.svg" alt="add icon"> -->
                    ثبت قیمت بازار
                </a>
            </li>
            <li class="mx-1 <?= $category == 'messages' ? 'bg-gray-400' : 'bg-gray-200' ?> hover:bg-gray-400 text-sm font-bold">
