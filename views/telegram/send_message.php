...
define('BATCH_SIZE', 5); // Number of messages per batch
define('BATCH_DELAY', 180); // Delay between batches in seconds
define('MESSAGE_DELAY', 30); // Delay between individual messages in seconds
